      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-center text-slate-500 dark:text-slate-400 mb-8 text-sm">Enter your details to access your account</p>
            ...
            <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
              ...
              <Link to="/signup" className="font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
                Sign up
              </Link>
            </p>
          </div>
